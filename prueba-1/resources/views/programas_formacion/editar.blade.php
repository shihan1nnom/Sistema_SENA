@extends('layout')
@section('titulo', 'Editar - Programas Formacion')

@section('contenido')
<div class="card" style="opacity:0.7">
<div class="card-body">
  <h5 class="card-title">Editar programas de formacion</h5>
  <p class="card-text">
    <form action="{{route('programas_formacion.actualizar', $programa->id)}}" method="post">
      @csrf
      @method('PUT')
      <div class="mb-3">
