        ...
        <tbody>
           @foreach($programas as $programa)
            <tr>
              ...
              <td>
                <a class="btn btn-link" href="{{route('programas_formacion.editar', $programa->id)}}" style="margin-top: -8px" data-bs-toggle="tooltip" data-bs-placement="right" title="Editar">
